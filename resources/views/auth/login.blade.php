                        ...
                        <div class="col-12">
                            <form class="form-horizontal mt-3 form-material" id="loginform" action="{{ route('login') }}" method="POST">
                                ...
                                <div class="form-group mb-3">
                                    <div class="">
                                        <input class="form-control @error('email') is-invalid @enderror" type="text" name="username" placeholder="Username" name="username" value="{{ old('username') }}" required autofocus> </div>
                                        @error('username')
