    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <form action="{{ route('webadmin.galeri-update',$photo->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                    <div class="card-body">
                        <fieldset>
                            ...
                            <div class="form-group mb-2">
                                ...
                                <div class="input-group">
                                    <img src="{{ $path }}" class="d-block position-relative w-100" alt="user" />
                                    {{-- <div class="custom-file">
                                        <input class="form-control" name="url" type="text" value="{{ $photo->url }}" disabled>
                                    </div> --}}
                    ...
                    <div class="card-footer">
                        {{-- <button type="submit" class="btn btn-flat btn-primary" >Publish</button> --}}
