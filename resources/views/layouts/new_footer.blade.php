        ...
        <div class="col-md-6 col-lg-3">
          <div class="ftco-footer-widget mb-5 ml-md-4">
            ...
            <ul class="list-unstyled">
              <li><a href="{{ route('home') }}"><span class="ion-ios-arrow-round-forward mr-2"></span>Beranda</a></li>
              <li><a href="https://ppdb.ramahanak.sch.id/"><span class="ion-ios-arrow-round-forward mr-2"></span>PPDB</a></li>
              <li><a href="{{ route('unit',"sdi") }}"><span class="ion-ios-arrow-round-forward mr-2"></span>SDI</a></li>
              <li><a href="{{ route('unit',"smpi") }}"><span class="ion-ios-arrow-round-forward mr-2"></span>SMPI</a></li>
            </ul>
          </div>
        </div>
        <div class="col-md-6 col-lg-3">
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> Ramah Anak 
