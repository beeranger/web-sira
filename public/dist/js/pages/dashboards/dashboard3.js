...
$(function () {
    ...
    var chart_area_spline = new ApexCharts(document.querySelector("#sales-ratio"), sales_ratio);
    ...
    var chart_area_basic = new ApexCharts(document.querySelector("#weather-report"), option_weather_report);
    ...
    var chart_pie_donut = new ApexCharts(document.querySelector("#campaign-status"), campaign_status);
    ...
    var chart_column_stacked = new ApexCharts(document.querySelector("#yearly-comparison"), yearly_comparison);
